Результат:  
https://gentle-forest-30372.herokuapp.com/ (подождите 20-40 сек, пока стартует dyno)
...
Вы присылаете только ссылку на ваш репозиторий на почту. У нас в компании применяется Git, и если вы его не знаете, вам стоит освоить базу самостоятельно.
